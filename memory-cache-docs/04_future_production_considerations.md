...
- **`.first` can mask ambiguity.** Accepted deliberately - degrading to "the same element as last
  time" beats raising Playwright strict mode and handing the step to the LLM;
